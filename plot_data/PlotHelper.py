...
class PlotHelper():
    ...
    def plot_confusion_matrix(self, confusion_matrix, labels):
        """
        Takes in a confusion matrix and labels, and returns a matplotlib figure
        """

        def helper(cm, classes, normalize=False, title='Confusion matrix', cmap=plt.cm.Blues):
            """
        ...
        helper(confusion_matrix, labels)
