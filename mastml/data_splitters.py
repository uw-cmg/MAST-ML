...
from mastml.feature_generators import ElementalFractionGenerator
try:
    import keras
except:
...
class LeaveOutCloseCompositions_INPROGRESS(BaseSplitter):
    """
    Leave-P-out where you exclude materials with compositions close to those the test set
    ...
    def __init__(self, composition_df, dist_threshold=0.1, nn_kwargs=None):
        ...
        # composition_df  willl be generated by 
