...
# Needed imports for heat map of Pearson correlation matrix
...
"""
New added method. Plz check its function
I also import seaborn as sns at the beginning
"""
def plot_correlation_heatmap(x_features, savepath):
    """
    This is the new added method to plot heat map of Pearson correlation matrix for input features.
    
    Args:
        
        x_features: (pandas Dataframe), features used in analyzing correltions
        savepath: (str), path to save the generated heapmap plots
    ...
    sns.heatmap(x_features.corr(), annot=True, cmap="YlGnBu")
    plt.tight_layout()
    plt.savefig(savepath, dpi=DPI, bbox_to_inches='tight')
