...
python3 -m mastml.mastml tests/conf/advanced_feature_selection_classification.conf tests/csv/classification.csv -o advanced_feature_classification
python3 -m mastml.mastml tests/conf/advanced_feature_selection_regression.conf tests/csv/regression_data.csv -o adavanced_feature_regression
