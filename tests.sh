...
python -m mastml.mastml tests/conf/pca_multiname.conf tests/csv/3d_utility.csv -o results/multiple_names
python -m mastml.mastml tests/conf/pca_basic.conf tests/csv/3d_utility.csv -o results/pca_basic
...
python -m mastml.mastml tests/conf/feature_gen.conf tests/csv/feature_generation.csv -o results/generation
