...
def main(importpath):
    ...
    create_cd_ivar(db, "cd1_ivaralltemp", "cd1_ivaralltemp_pre", "cd_ivar_2016")
    cas.export_spreadsheet(db, "cd1_ivaralltemp", exportpath)
    ...
    create_cd_ivar(db, "cd2_ivar", "expt_ivaralltemp", "cd_ivar_2017")
