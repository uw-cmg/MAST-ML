...
os.system('pip install scikit-learn-extra scikit-learn scikit-optimize matminer matplotlib mdf_forge mdf-toolbox numpy openpyxl pandas pathos pykan==0.0.5 pymatgen pyyaml scipy shap statsmodels madml udocker transfernet forestci')
