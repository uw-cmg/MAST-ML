...
os.system('pip install aflow atomicwrites attrs certifi chardet citeproc-py citrination-client configobj cryptography cycler Cython decorator dominate duecredit folium forestci future globus_nexus_client globus_sdk httplib2 idna imageio imgaug importlib-metadata ipython-genutils jdcal jsonschema jwt keras kiwisolver matminer matplotlib mdf_forge	mdf-toolbox mlxtend monty nbformat networkx nose numpy openpyxl packaging palettable pandas pint plotly pluggy psutil py PyDispatcher pymatgen pymongo pyparsing pypif pytest python-dateutil pytz pyyaml requests retrying	ruamel.yaml scikit-learn scikit-optimize scipy six spglib sphinx-automodapi sympy tabulate tensorflow tqdm traitlets urllib3 wcwidth xlrd zipp')
