...
os.system('pip install citrination-client configobj dlhub_sdk dominate forestci globus_nexus_client globus_sdk keras matminer matplotlib mdf_forge mdf-toolbox mlxtend nbformat numpy pandas pymatgen scikit-learn scikit-optimize scipy sphinx-automodapi tensorflow urllib3 xlsxwriter')
...
copyright = '2021, University of Wisconsin-Madison Computational Materials Group'
